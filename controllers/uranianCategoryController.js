...
const createUranianHistory = async (req, res) => {
  try {
    const {
      userId,
      //   tarotCategoryName,
...
You are an expert Uranian Astrology analyst.

Based on the user's birth details, generate Uranian Astrology insights in a structured JSON format for a web application.
...
`.trim();
    ...
    console.log("✅ LifeGraph AI Response received");
    ...
    const chatHistory = await UranianCategoryModel.create({
      userId: userId || null,
